...
import config.IWXPayDomain;
import config.WXPayConfigImpl;
...
public class WXPayRequest {
    private static WXPayConfigImpl config=new WXPayConfigImpl();
     ...
     * @throws Exception
     */
    public static String requestByXml(String url, String data) throws Exception {
